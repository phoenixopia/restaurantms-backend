...
module.exports = async () => {
  const permissionsData = [
    ...
    { name: "manage_restaurant", description: "Can manage restaurant settings" },
    ...
    { name: "toggle_menu_activation", description: "Can toggle menu activation" },
    ...
    { name: "toggle_menu_category_activation", description: "Can toggle menu category activation" },
    ...
    { name: "toggle_menu_item_activation", description: "Can toggle menu item activation" },
    { name: "upload_video", description: "Can upload video" },
  ];
